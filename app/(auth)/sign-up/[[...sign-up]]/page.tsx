...
export default function SignUpPage() {
  return (
    <div className="min-h-screen grid w-full items-center bg-zinc-100 px-4 font-mono text-sm text-white">
      <SignUp.Root>
        <SignUp.Step
          name="start"
          ...
          <SignUp.Strategy name="email_code">
            <Clerk.Field name="code" className="space-y-1">
              ...
              <Clerk.Input
                type="otp"
                required
                className="w-full px-3 py-2 bg-zinc-900 border-2 border-black shadow-[3px_3px_0_0_#000] focus:border-yellow-400 text-white"
              />
              <Clerk.FieldError className="text-sm text-red-500" />
            </Clerk.Field>
            <SignUp.Action
