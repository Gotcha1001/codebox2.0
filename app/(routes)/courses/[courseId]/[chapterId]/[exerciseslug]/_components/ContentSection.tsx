    ...
    <div className="p-10 mb-28">
      {loading || !ContentInfo ? (
        ...
        <div>
          ...
          />
          <div>
            <h2 className="font-game text-2xl mt-4">Task</h2>
            <div
              className="p-4 border-2 rounded-lg bg-zinc-800 "
              dangerouslySetInnerHTML={{
          ...
          <div>
            <h2 className="font-game text-2xl mt-4 flex gap-2 items-center text-yellow-400">
              <Lightbulb /> Hint
            </h2>
            <div
              className="p-4 border-2 rounded-lg bg-zinc-800 "
